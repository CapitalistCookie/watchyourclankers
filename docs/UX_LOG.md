...
> Files governed here for coverage: `web/resize.js`, `web/app-config.js`, `web/app.js`, `web/menu.js`, `web/mosaic.js`, `web/ide.js`, `web/debug.js`, `web/client.js`, `web/store.js`, `web/assign.js`, `web/idegeom.js`, `web/reveal.js`, `web/readscan.js`.
